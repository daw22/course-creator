...
from prerequisite_analyzer.nodes import get_prerequisites, prepare_questions, get_answer, route_human_input, suggest_course_target
...
app = graph.compile(checkpointer=MemorySaver(), interrupt_before=["course_title_response", "get_answer", "get_course_target"])
