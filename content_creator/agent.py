...
content_creator_graph.set_start("generate_content")
...
content_creator_graph.add_edge("store_content", "chapter_router")
content_creator_graph.add_edge("create_quiz", "quiz_time")
content_creator_graph.add_edge("quiz_time", "quiz_router")

content_creator_app = content_creator_graph.compile(interrupt_before=["quize_time"])