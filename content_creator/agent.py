from content_creator.nodes import generate_content,  store_content
# from content_creator.nodes import chapter_router, create_quiz, quiz_time, quiz_router, store_quiz_result, summary_and_questions
...
content_creator_graph.add_edge("generate_content", "store_content")
...
content_creator_app = content_creator_graph.compile(checkpointer=checkpointer)